...
# temp ----
temp_cat <- read_stars("outputs/expo_predaggr2/2020/temp_2020_year_pred.tif")
...
# pm25 ----
pm25_cat <- read_stars("outputs/expo_predaggr2/2020/pm25_2020_year_pred.tif")
...
# pm10 ----
pm10_cat <- read_stars("outputs/expo_predaggr2/2020/pm10_2020_year_pred.tif")
...
# no2 ----
no2_cat <- read_stars("outputs/expo_predaggr2/2020/no2_2020_year_pred.tif")
...
# o3 ----
o3_cat <- read_stars("outputs/expo_predaggr2/2020/o3_2020_year_pred.tif")
